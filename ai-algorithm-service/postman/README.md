...
Xem [../docs/demo-quickstart.md](../docs/demo-quickstart.md) để có hướng dẫn step-by-step end-to-end (gồm cả setup Docker, build bundle, upload MinIO).
...
| `409 AREA_NOT_READY` | Chưa copy legacy model files hoặc area chưa map `networkId=cologne3`. Xem [../docs/demo-quickstart.md](../docs/demo-quickstart.md#6-test-inference) |
